 ...
 */
@Configuration
@EnableConfigurationProperties(ControllerRegistrationProperties.class)
@ComponentScan(basePackageClasses = ControllerRegistrationAutoConfiguration.class)
@PropertySource("classpath:/application-registration-controller.yml")
public class ControllerRegistrationAutoConfiguration {
