...
@ImportAutoConfiguration(classes = {
        TestServiceRegistrationAutoConfiguration.class,
        WebMvcAutoConfiguration.class,
        HttpMessageConvertersAutoConfiguration.class,
        ControllerRegistrationAutoConfiguration.class,
        SpringDataWebAutoConfiguration.class,
})
@EnableAutoConfiguration
@ActiveProfiles("registration-controller-test")
public class TestControllerRegistrationAutoConfiguration {
